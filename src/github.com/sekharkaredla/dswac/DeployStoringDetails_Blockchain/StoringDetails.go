...
const StoringDetailsABI = "[{\"constant\":true,\"inputs\":[],\"name\":\"getJWT\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"newJWT\",\"type\":\"string\"}],\"name\":\"setJWT\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"JWT\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"initialJWT\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}]"

// StoringDetailsBin is the compiled bytecode used for deploying new contracts.
const StoringDetailsBin = ``

// DeployStoringDetails deploys a new Ethereum contract, binding an instance of StoringDetails to it.
func DeployStoringDetails(auth *bind.TransactOpts, backend bind.ContractBackend, initialJWT string) (common.Address, *types.Transaction, *StoringDetails, error) {
...
//
// Solidity: function JWT() constant returns(string)
func (_StoringDetails *StoringDetailsCaller) JWT(opts *bind.CallOpts) (string, error) {
	var (
		ret0 = new(string)
	)
	out := ret0
...
//
// Solidity: function JWT() constant returns(string)
func (_StoringDetails *StoringDetailsSession) JWT() (string, error) {
...
//
// Solidity: function JWT() constant returns(string)
func (_StoringDetails *StoringDetailsCallerSession) JWT() (string, error) {
	return _StoringDetails.Contract.JWT(&_StoringDetails.CallOpts)
}

// GetJWT is a free data retrieval call binding the contract method 0x2cd38f8c.
//
// Solidity: function getJWT() constant returns(string)
func (_StoringDetails *StoringDetailsCaller) GetJWT(opts *bind.CallOpts) (string, error) {
	var (
		ret0 = new(string)
	)
	out := ret0
...
//
// Solidity: function getJWT() constant returns(string)
func (_StoringDetails *StoringDetailsSession) GetJWT() (string, error) {
...
//
// Solidity: function getJWT() constant returns(string)
func (_StoringDetails *StoringDetailsCallerSession) GetJWT() (string, error) {
	return _StoringDetails.Contract.GetJWT(&_StoringDetails.CallOpts)
}

// SetJWT is a paid mutator transaction binding the contract method 0x528a6328.
//
// Solidity: function setJWT(newJWT string) returns()
func (_StoringDetails *StoringDetailsTransactor) SetJWT(opts *bind.TransactOpts, newJWT string) (*types.Transaction, error) {
...
//
// Solidity: function setJWT(newJWT string) returns()
func (_StoringDetails *StoringDetailsSession) SetJWT(newJWT string) (*types.Transaction, error) {
...
//
// Solidity: function setJWT(newJWT string) returns()
func (_StoringDetails *StoringDetailsTransactorSession) SetJWT(newJWT string) (*types.Transaction, error) {
	return _StoringDetails.Contract.SetJWT(&_StoringDetails.TransactOpts, newJWT)
}
