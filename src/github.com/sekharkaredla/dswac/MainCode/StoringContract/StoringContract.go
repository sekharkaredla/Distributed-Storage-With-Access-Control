...
const StoringDetailsBin = ``

// DeployStoringDetails deploys a new Ethereum contract, binding an instance of StoringDetails to it.
func DeployStoringDetails(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *StoringDetails, error) {
	parsed, err := abi.JSON(strings.NewReader(StoringDetailsABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(StoringDetailsBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
